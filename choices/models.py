...
def custom_export(players):
    yield['session', 'participant_code', 'prolific_id', 'round', 'choice', 'brand', 'type', 'prod_number', 'attribute1',
    ...
    for p in players:
        ...
        for item in items:
            ...
            yield (
                [p.session.code, p.participant.code, p.participant.vars.prolific_id, p.round_number, p.choice, p.brand] + [item.product_type,
