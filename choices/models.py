...
def custom_export(players):
    yield['session', 'participant_code', 'round', 'choice', 'brand', 'type', 'prod_number', 'attribute1',
    ...
    for p in players:
        ...
        for item in items:
            ...
            yield (
                [p.session.code, p.participant.code, p.round_number, p.choice, p.brand] + [item.product_type,
